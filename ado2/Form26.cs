...
namespace ado2
{
    public partial class Form26 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE Questions SET q = @q, op1ion1 = @op1ion1, option2 = @option2, option3 = @option3, option4 = @option4, answer = @answer WHERE qid = @qid";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show("Error updating the question. Please check the QID and try again.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
